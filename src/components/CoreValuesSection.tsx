...
const coreValues = [
  ...
  },
  {
    ...
    color: "from-category-purple/20 to-category-purple/10",
  ...
  },
  {
    ...
    color: "from-category-pink/20 to-category-pink/10",
    iconColor: "text-category-pink",
  },
  {
    icon: Zap,
    titleKey: "coreValues.efficiency.title",
    descriptionKey: "coreValues.efficiency.description",
    color: "from-category-orange/20 to-category-orange/10",
    iconColor: "text-category-orange",
  },
];
