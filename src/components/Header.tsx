...
export const Header = () => {
  ...
  const productItems = [
    ...
    { label: "Educational Activities by Age", href: localizedPath("/indoor-play-center-educational-activities-by-age") },
    ...
    { label: "Hygienic Infant Play Area", href: localizedPath("/hygienic-indoor-playground-for-infants") },
    { label: "Home Playroom for Toddlers", href: localizedPath("/home-playroom-design-for-toddlers") },
    { label: "Play Equipment for Small Spaces", href: localizedPath("/safe-indoor-playground-equipment-for-small-spaces") },
    { label: "Accessible Playground Design", href: localizedPath("/accessible-indoor-playground-design-for-disabilities") },
    { label: "Playground Flooring & Mats", href: localizedPath("/commercial-indoor-playground-flooring-and-mats") },
        ...
        <div className="container-wide">
          <div className="flex items-center justify-between h-16 md:h-20">
            ...
            <Link to={localizedPath("/")} className="flex items-center py-2">
              <img src={logo} alt="NinescapeLand" className="h-14 md:h-20 w-auto max-w-[200px] md:max-w-[280px] object-contain" loading="eager" decoding="async" width="280" height="80" />
            </Link>
