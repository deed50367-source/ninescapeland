            ...
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button size="lg" variant="hero" asChild>
                  <a href="#contact">{t("roiCanada.hero.cta")} <ArrowRight className="ml-2 h-4 w-4" /></Link>
                </Button>
          ...
          <div className="container mx-auto px-4">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="max-w-4xl mx-auto">
              ...
              <div className="mt-8 text-center">
                <Button variant="hero" asChild><a href="#contact">{t("roiCanada.section2.cta")}<ArrowRight className="ml-2 h-4 w-4" /></a></Button>
              </div>
            </motion.div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="flex flex-wrap justify-center gap-3">
                <Button variant="outline" size="sm" asChild><Link to={localizedPath("/products")}>{t("roiCanada.relatedLinks.allProducts")}</a></Button>
                <Button variant="outline" size="sm" asChild><Link to={localizedPath("/process")}>{t("roiCanada.relatedLinks.process")}</a></Button>
                <Button variant="outline" size="sm" asChild><Link to={localizedPath("/case-studies")}>{t("roiCanada.relatedLinks.caseStudies")}</a></Button>
              </div>
            </div>
          </div>
        </section>
